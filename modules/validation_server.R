#validation_server
validation_server <- function(id, activated){
  ...
  moduleServer(id, function(input, output, session) {
    ...
    #UI
    output$validation_ui_page <- renderUI({
      fluidPage(
        ...
        fluidRow(
          column(
            ...
            h2(
              ...
              span(paste("IOTC data validation and analysis"))
            )
          )
        ),
        fluidRow(
